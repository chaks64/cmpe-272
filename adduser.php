                      ...
                      <form class="mx-1 mx-md-4" action="insert.php" method="post">
                        ...
                        <div class="d-flex flex-row align-items-center mb-4">
                          ...
                          <div class="form-outline flex-fill mb-0">
                            ...
                            <label class="form-label" for="form3Example4c">Home Address</label>
                          </div>
                        </div>
                        ...
                        <div class="d-flex flex-row align-items-center mb-4">
                          ...
                          <div class="form-outline flex-fill mb-0">
                            <input type="number" id="form3Example4cd" class="form-control" name="home"/>
                            <label class="form-label" for="form3Example4cd">Home Phone</label>
                          </div>
                        </div>
